package org.example.thirdpartyapiinterceptor.controller;
...
public class PostController {
    ...
    @GetMapping("/get")
    Map<String,Object>getThirdParty( @RequestParam String name  ){
        return   postService.callThirdPartyAPI( name );
    }
